      ...
      if (address) {
        ...
        if (agentsRes.ok) {
          ...
          if (userAgents) {
            ...
            if (!preSelectedAgentId && agentsArray.length > 0) {
              setServiceData(prev => ({ ...prev, agentId: agentsArray[0].id }));
            }
          }
        }
      }
      ...
      <div className="page-container">
        <div className="page-header">
          ...
          <div className="header-content">
            ...
            <p className="header-subtitle">Add a new service to your agent</p>
          </div>
        </div>
        ...
        <div className="form-card">
          {agents.length === 0 ? (
            <div className="no-agents-message">
              ...
              <p>You need to create an agent first before adding services.</p>
                ...
                <div className="form-row single">
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      placeholder='{"type": "object", "properties": {"example_field": {"type": "string"}}}'
